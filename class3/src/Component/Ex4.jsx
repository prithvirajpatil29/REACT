...
class Ex4 extends Component{
    ...
    render(){
        ...
        return (
            ...
            <div className='row'>
            <p className="bg-secondary py-3 fs-2 text-white text-center ">Variable in class Component</p>
            <div className="col-sm-12 col-lg-12 col-md-12 col-xl-12 col-xxl-12 fs-5">
                <h2 className='bg-secondary text-white text-center'>Example - 4</h2>
            </div>
            <div className="col">
                <div className="border  border-info lead p-3 text-center">
                    <h3>Varianle in  Arrow function component</h3>
